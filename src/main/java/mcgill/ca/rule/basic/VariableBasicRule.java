...
public class VariableBasicRule extends AbstractRule
{

	public VariableBasicRule(String name, String description, String label, int priority)
	{
		super(name, description, label, priority);
	}

	public VariableBasicRule()
	{
	}
